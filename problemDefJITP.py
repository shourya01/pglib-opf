...
class opfSocp():
    ...
    def initModelTracker(self):
        ...
        self.active_constr = np.zeros_like(self.is_model)
        self.active_constr[self.is_model == 1] = 1
        self.active_constr[self.is_model == 0] = 1
    ...
    def jacobian(self, x):
        ...
        return (self.jac_const + z)[np.repeat(self.active_constr,self.num_indices_per_constr) == 1]
    ...
    def hessian(self, x, _lam, _objfac):
        ...
        _objfac[self.active_constr == 0] = 0
