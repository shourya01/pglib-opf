...
import warnings
import cyipopt
from problemDefJIT import opfSocp
...
if __name__ == "__main__":
    ...
    for cn,this_case in iterlist:
        ...
        # prob.add_option('hsllib','/usr/local/lib/libmkl_core.so')
        ...
        prob.add_option('corrector_type','primal-dual')
        prob.add_option('soc_method',1)
        prob.add_option('least_square_init_primal','no')
        prob.add_option('least_square_init_duals','no')
